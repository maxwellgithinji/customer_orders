...
func TestValidateEmptyEmail(t *testing.T) {
	customer := models.Customer{ID: 1, Name: "maxgit", Email: "", Code: "123a"}
	testService := NewCustomerService(nil)
...
func TestValidateSuccess(t *testing.T) {
	customer := models.Customer{ID: 1, Name: "maxgit", Email: "maxwellgithinji@gmail.com", Code: "123a"}
	testService := NewCustomerService(nil)
	err := testService.ValidateCustomer(&customer)
...
func TestFindAllCustomers(t *testing.T) {
	...
	assert.Equal(t, "maxgit", res[0].Name)
...
func TestCreateACustomer(t *testing.T) {
	...
	assert.Equal(t, "maxgit", res.Name)
