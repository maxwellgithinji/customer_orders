...
- this project should use the following guide
- changes to the guide may change
- changes to the project may also occur in order to be in concurrence with the style guide in later versions
- Original reference => [Uber Go Style Guide](https://raw.githubusercontent.com/bitz0x75/guide/master/style.md)
- the project also tries to follow a clean architecture from [Uncle Bob](https://blog.cleancoder.com/uncle-bob/2012/08/13/the-clean-architecture.html)
- check out [this article](https://eminetto.medium.com/clean-architecture-using-golang-b63587aa5e3f)
